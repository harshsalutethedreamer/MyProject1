...
public class NumeroRecyclerAdapter extends RecyclerView.Adapter<NumeroRecyclerViewHolder>{
    ...
    private NumeroRecyclerViewHolder.Ondeletelistener mDeleteListener;
    ...
    @Override
    public void onBindViewHolder(NumeroRecyclerViewHolder holder, final int position) {
...
//                dialog.show(sFragmentManager,"choice-by-user");
        ...
        holder.setClickListener(new NumeroRecyclerViewHolder.ClickListener(){
            @Override
    ...
    public NumeroRecyclerViewHolder onCreateViewHolder(ViewGroup parent, final int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.n_one,null);
    ...
    public void setData(List<InformationActivity> numeros){
...
//
//        LinearLayout linearLayout = (LinearLayout)view.findViewById(R.id.categorybox);
//        TextView textView = (TextView) view.findViewById(R.id.nname);
//        String a=linearLayout.getTag().toString();
...
//            mDeleteListener.onDeletelistener(_id,name);
//        }
//
//        notifyItemChanged(focusedItem);
//        focusedItem=mRecyclerView.getChildAdapterPosition(view);
//        notifyItemChanged(focusedItem);
//
//        return true;
//    }

    public void setOnDeleteClickListener(NumeroRecyclerViewHolder.Ondeletelistener l){
        mDeleteListener=l;
    }
