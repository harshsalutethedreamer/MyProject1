...
public class NewSequenceEncoder {
    ...
    public NewSequenceEncoder(File out) throws IOException {
    ...
    public void encodeNativeFrame(Picture pic) throws IOException {
        ...
        outTrack.addFrame(new MP4Packet(result, frameNo*25, 1, 2, frameNo, true, null, frameNo * 25, 0));
