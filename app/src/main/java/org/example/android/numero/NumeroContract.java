...
public class NumeroContract {
    ...
    public static final String CONTENT_AUTHORITY="org.example.android.numeros.provider";
    public static final Uri BASE_CONTENT_URI= Uri.parse("content://" + CONTENT_AUTHORITY);

    private static final String PATH_FRIENDS="numeros";
    ...
    public static final String[] TOP_LEVE_PATHS = {
            ...
            public static class Numeros implements NumeroColumns,BaseColumns {
                ...
                public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd." + CONTENT_AUTHORITY + ".numeros";
                public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd." + CONTENT_AUTHORITY + ".numeros";
